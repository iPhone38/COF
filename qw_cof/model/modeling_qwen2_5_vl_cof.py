...
from ..utils.utils import GenerationMixin
...
class Qwen2_5_VLForConditionalGeneration_COF(Qwen2_5_VLPreTrainedModel, GenerationMixin):
    ...
    def prepare_inputs_for_generation(
        ...
        **kwargs,
        ...
        # 认为模型只要第一次forward会输入图像，实际上在COF追加的时候也有图像加入
...
__all__ = ["Qwen2_5_VLForConditionalGeneration_COF", "Qwen2_5_VLModel", "Qwen2_5_VLPreTrainedModel", "Qwen2_5_VLTextModel"]
